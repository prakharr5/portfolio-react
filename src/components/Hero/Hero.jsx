      ...
      <div className="main">
        <div className="compOne">
          ...
          <div className="nav">
            ...
            <div className="reach">
              <a
                href="https://drive.google.com/file/d/1rcyGmu21yx1VpWuBsJ9vzmJ5rlauO1m6/view?usp=sharing"
                className="downcv"
              >
                Download CV
              </a>
          ...
          <div className="work">
            ...
            <a href="https://drive.google.com/file/d/1rcyGmu21yx1VpWuBsJ9vzmJ5rlauO1m6/view?usp=sharing">
              Download CV
            </a>
          </div>
